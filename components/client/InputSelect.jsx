...
const classLabel = `absolute left-3.75 top-0 -translate-y-1/2
                    text-current text-zinc-800 dark:text-zinc-100 bg-zinc-50 dark:bg-zinc-800                     
...
export const InputSelect = ({ label = "", name, options, disabled, multiple, className = "" }) => {
    ...
    const Input = ({ label, value }) => {
        ...
        return (
            <label className="flex items-center gap-2 w-full text-zinc-800 dark:text-zinc-100">
                <input

...
// export function Switch({ labelOn, labelOff, value = false, onChange }) {
...
//                         absolute size-5 rounded-full bg-white shadow
//                         transition-transform duration-300 ease-in-out
//                         ${val ? "translate-x-0" : "translate-x-24"}
//                     `}
//             />

//             <span className={`z-10 w-full text-center text-sm font-medium text-white text-clip`} >

...
const menuClasses = `${colorBase} not-lg:mt-2 not-lg:py-5 px-8 py-1 peer-not-checked:hidden lg:peer-not-checked:flex flex flex-col gap-2 lg:flex-row absolute lg:relative right-0 top-full lg:w-auto rounded-lg lg:border-none lg:shadow-none shadow-lg`
